...
var lblnon_designMode  = '使用字体编辑器, 需要 <a href="http://www.mozilla.org/" target="_new">Mozilla 1.3+或以上版本</a> 浏览器 (eg, <a href="http://www.mozilla.org/products/firefox/" target=_new>Firefox</a>), Safari 1.3+, Opera 9+  或者 <a href="http://www.microsoft.com/windows/ie/default.asp" target="_new">MS IE5+或以上版本</a> (Windows) . IE5(Mac) 浏览器不支持当前编辑器，所有字体必须是HTML编码.';
